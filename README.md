...
## Internship
* Designed and prototyped a Raspberry Pi-based device for commercial sale.
* Developed Python and Bash scripts to automate device operation.
* Wrote documentation for code, Linux configuration and CAD designs.
* Communicated with non-technical stakeholders across different fields to understand business requirements and deliver the product in time for initial deployment.

More information can be found here: https://www.proscience.uk/jekyll/update/2025/08/20/waspooker.html

## Publications
Contributed software development and validation work to the following research project:

Automated remote nesting habitat surveying for wild bumblebees
https://doi.org/10.1002/3070-5436.70001
